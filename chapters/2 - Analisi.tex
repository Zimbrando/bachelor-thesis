...
\begin{figure}[htb]
	\centering
	\includegraphics[width=1\linewidth]{figures/gradle-build-lifecycle-example.png}
...
\begin{figure}[htb]
	...
	\caption{Sintesi dei componenti utilizzati su GitHub Actions ed esempio di un workflow} 
