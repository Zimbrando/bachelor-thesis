...
\lstinputlisting[float=htb,language=Actions,label={lst:matrix-strategy}, caption={Utilizzo della strategia a matrice per configurare job paralleli}]{listings/matrix-strategy.yml}
